// Shared tutorial UI for K&E Deci-Lon (Equation input, Generate, Replay, step controls).
// Depends: equation_parser.js, dynamic_tutorial_decilon.js (generateDynamicTutorial, playDynamicLesson, dynamicTutorialState, step functions).
(function () {
  'use strict';
